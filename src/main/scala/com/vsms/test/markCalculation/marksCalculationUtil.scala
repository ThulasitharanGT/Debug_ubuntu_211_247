package com.vsms.test.markCalculation

import com.vsms.test.markCalculation.marksCalculationConstant._
...
object marksCalculationUtil extends Serializable{
  ...
  def getSparkSession(conf:org.apache.spark.SparkConf=null)= conf match {
    case null => org.apache.spark.sql.SparkSession.builder.master("local[*]").enableHiveSupport.getOrCreate
    case value => org.apache.spark.sql.SparkSession.builder.master("local[*]").enableHiveSupport.config(value).getOrCreate
  }
