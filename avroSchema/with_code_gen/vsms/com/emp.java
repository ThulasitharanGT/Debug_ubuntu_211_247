...
public class emp extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"emp\",\"namespace\":\"vsms.com\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"salary\",\"type\":\"int\"},{\"name\":\"age\",\"type\":\"int\"},{\"name\":\"address\",\"type\":\"string\"}]}");
  ...
  public static vsms.com.emp.Builder newBuilder() {
    return new vsms.com.emp.Builder();
  }
  
  /** Creates a new emp RecordBuilder by copying an existing Builder */
  public static vsms.com.emp.Builder newBuilder(vsms.com.emp.Builder other) {
    return new vsms.com.emp.Builder(other);
  }
  
  /** Creates a new emp RecordBuilder by copying an existing emp instance */
  public static vsms.com.emp.Builder newBuilder(vsms.com.emp other) {
    return new vsms.com.emp.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<emp>
    ...
    private Builder() {
      super(vsms.com.emp.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(vsms.com.emp.Builder other) {
      super(other);
    ...
    private Builder(vsms.com.emp other) {
            super(vsms.com.emp.SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'name' field */
    public vsms.com.emp.Builder setName(java.lang.CharSequence value) {
    ...
    public vsms.com.emp.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'id' field */
    public vsms.com.emp.Builder setId(int value) {
    ...
    public vsms.com.emp.Builder clearId() {
    ...
    /** Sets the value of the 'salary' field */
    public vsms.com.emp.Builder setSalary(int value) {
    ...
    public vsms.com.emp.Builder clearSalary() {
    ...
    /** Sets the value of the 'age' field */
    public vsms.com.emp.Builder setAge(int value) {
    ...
    public vsms.com.emp.Builder clearAge() {
    ...
    /** Sets the value of the 'address' field */
    public vsms.com.emp.Builder setAddress(java.lang.CharSequence value) {
    ...
    public vsms.com.emp.Builder clearAddress() {
      address = null;
